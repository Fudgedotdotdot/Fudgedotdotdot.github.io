...
title = "The state of sandbox evasion techniques in 2024"
date = "2024-09-02"
categories = [
    "sandbox evasion",
]
...
<table>
    <tr>
        <td style="border: 0;"><img src="results-hkcu.png"></td>
        <td style="border: 0;"><img src="results-hklm.png"></td>
    </tr>
</table>

When listing the directories in the *Program Files* and *Program Files (x86)*, about 10 sandboxes had weird directories :

![results-installed](results-programs.png)
...
<table>
    <tr>
        <td style="border: 0;"><img src="map-sandboxes-generic.png"></td>
        <td style="border: 0;"><img src="map-sandboxes-virustotal.png"></td>
    </tr>
    <tr>
        <td style="border: 0;"><img src="map-sandboxes-hybridanalysis.png"></td>
        <td style="border: 0;"><img src="map-sandboxes-recordedfuturtriage.png"></td>
    </tr>
</table>
...
located lower in memory than it is on guest (i.e., virtual) machines.*<br>*PS: Does not seem to work on newer version of VMWare Workstation (Tested on v12)*
...
![al-khaser](results-al-khaser.png)
...
[2] [https://anti-debug.checkpoint.com/techniques/timing.html](https://anti-debug.checkpoint.com/techniques/timing.html)
