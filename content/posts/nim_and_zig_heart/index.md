...
<table>
    <tr>
        <td style="border: 0;"><p>Compiling on Windows</p><img src="hello-windows-nim.png"></td>
        <td style="border: 0;"><p>Cross-Compiling on Linux</p><img src="hello-linux-nim.png"></td>
    </tr>
</table>
...
<table>
    <tr>
        <td style="border: 0;"><p>Compiling on Windows with Zig</p><img src="hello-windows-zig.png"></td>
        <td style="border: 0;"><p>Cross-Compiling on Linux with Zig</p><img src="hello-linux-zig.png"></td>
    </tr>
</table>
